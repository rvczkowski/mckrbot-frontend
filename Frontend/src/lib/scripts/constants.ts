export const BASE_PATH = import.meta.env.VITE_API_URL || "https://pterodactyl.rvcz.pl:8080" // <- Edit this string to your own API
export const INVITE_URL = import.meta.env.VITE_INVITE_URL || "https://rvcz.pl/mckrbot" // <- Edit this string to your Invite link
